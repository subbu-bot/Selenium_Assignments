...
public class SnapDealEx {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		builder.moveToElement(menFashion).moveToElement(menSportShoe).click().perform();
		...
		builder.moveToElement(driver.findElement(By.xpath("(//span[starts-with(@id,'display-price')])[last()]")))
				.perform();
		Thread.sleep(10000);
		...
		builder.moveToElement(viewColor).click().build().perform();
		...
		Thread.sleep(2000);
		builder.moveToElement(brandElement).click().perform();
		Thread.sleep(2000);
		...
		builder.moveToElement(blueShoe).moveToElement(quickView).click().build().perform();

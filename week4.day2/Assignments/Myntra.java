...
public class Myntra {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(5000);
		// Enable Mango Check
		builder.moveToElement(driver.findElement(By.xpath("(//input[@value='MANGO'])[2]"))).click().perform();
		// Click X
		...
		builder.moveToElement(sort).click(betterDiscount).build().perform();
		...
		builder.moveToElement(findPrice).perform();
